...
import carusel11 from '../../asstes/carousel-1.jpg';
import carusel12 from '../../asstes/carousel-2.jpg';
import carusel13 from '../../asstes/carousel-3.jpg';
import offer1 from '../../asstes/offer-1.jpg';
import offer2 from '../../asstes/offer-2.jpg';
            ...
            <div id="header-carousel" className="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item position-relative active" style={{height: '430px'}}>
                        <img className="position-absolute w-100 h-100" src={carusel11} style={{objectFit: 'cover'}} />
                    ...
                    <div className="carousel-item position-relative" style={{height: '430px'}}>
                        <img className="position-absolute w-100 h-100" src={carusel12}  style={{objectFit: 'cover'}} />
                        <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div className="p-3" style={{maxWidth: '700px'}}>
                    ...
                    <div className="carousel-item position-relative" style={{height: '430px'}}>
                        <img className="position-absolute w-100 h-100" src={carusel13}style={{objectFit: 'cover'}} />
                        <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div className="p-3" style={{maxWidth: '700px'}}>
